...
router.put('/:id', (req, res) => {
  const { stock_actual, stock_minimo, costo, precio_venta, nombre } = req.body;

  const resultado = productoService.actualizarProducto(req.params.id, {
    stock_actual,
    stock_minimo,
    costo,
    precio_venta,
...
router.delete('/:id', (req, res) => {
  const resultado = productoService.eliminarProducto(req.params.id);
